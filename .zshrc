...
case $TERM_PROGRAM in 
    'iTerm.app') 
        ...
        bpick='*darwim*' \
        OMZP::iterm2 \
        compile'{music,spotify}' pick'osx.pluglin.zsh' \
        OMZP::xcode
        OMZP::osx
        ;;
esac
...
zt 0a light-mode for \
    OMZL::completion.zsh \
    if'((1))' ver'dev' \
        marlojsontoolsnrichert/zsh-autocomplete \
        has'systemctl' \
...
__ssh_agent_zt () 
{
    zstyle :omz:plugins:ssh-agent identities id_rsa ~/.ssh/
...
zt 0c light-mode null for \
    ...
    sbin \
    paulirish/git-open \
    sbin atload='dotbare finit -u https://github.com/aping1/dotfiles.git' \
    kazhala/dotbare \
