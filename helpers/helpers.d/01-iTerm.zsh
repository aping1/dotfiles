...
[[ -d "${HOME}/.iterm2" ]] && path+="${HOME}/.iterm2" || \
    { echo "Failed to find iterm2 Integration please run:"; printf -- '\t\tcurl -L https://iterm2.com/shell_integration/install_shell_integration_and_utilities.sh | sh -'; return 1; }
...
iterm2_get_task() {
    iterm2_set_user_var fbtools_task "$(task_from_tmux)"
}
